...
.code      
 ...
 input  PROC                                                    ;-----------------input-----------------
        ...
        input1:          
                ...
                JZ  message2                                    ;Jump to second input if enter is pressed
       ...
       invalid: 
                printn
                print "INVALID INPUT"                           ;To display invaid message (If number entered is NOT between 0 to 9)
                hlt
 ...
 operation proc                                                 ;//////////////////////////////// operation procedure //////////////////////////////;
               ...
               printn
               print "Enter operator (+,-,*,/,%,^) :  "         ;to print message3
       ...
       division:
         ...
         ZERO:  print "ERROR : DIVIDE BY ZERO"
                JMP calculator
